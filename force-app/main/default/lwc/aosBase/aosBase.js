...
import {chunk, execute, flatten, getURlParams, showToast, validate} from 'c/aosUtils'
import {CurrentPageReference} from 'lightning/navigation';
import FORM_FACTOR from '@salesforce/client/formFactor';
import {CloseActionScreenEvent} from 'lightning/actions';

export default class AosBase extends LightningElement {
    ...
    get baseCmp() {
        return this.template.querySelector('c-aos-base');
    }
    ...
    @api
    get stepperCmp() {
        return this.template.querySelector('c-aos-stepper');
    }
...
export {AosBase, showToast, execute, validate, flatten, chunk, getURlParams}